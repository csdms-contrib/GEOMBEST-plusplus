...
while flag == 1
    ...
    if exist (filename) == 2 % ie the tract# exel file exists
        j = j + 1;
         [numbers,text]= xlsread(filename, 'Sheet1', 'a1:r2000'); % reads the filename and creates two matrices representing: 1) the numbers, and 2) the text from the exel file 
